import { Consistency, RecipeByID } from './types';

export const recipeId782585:RecipeByID = {
  vegetarian: true,
  vegan: true,
  glutenFree: true,
  dairyFree: true,
