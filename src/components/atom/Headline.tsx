...
/**
* Reusable component for all the titles(headlines) on the pages by default is already set:
* @prop: align, to align the text, by default it`s: center, but can be change with props, 
* alternative values: 'left', 'right', 'justify'
* @prop: variantHeadline: by default it`s 'h1', alternative values: 'h2', 'h3', 'h4', 
* 'h5', 'h6', 'subtitle1', 'subtitle2', it`s all in a type. As it`s
